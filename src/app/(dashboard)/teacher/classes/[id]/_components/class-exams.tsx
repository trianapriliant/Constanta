...
import { ExamActions } from '../exams/_components/exam-actions'
            ...
            <CardContent>
                {exams.length === 0 ? (
                    ...
                    <div className="space-y-3">
                        {exams.map((exam) => (
                            <div key={exam.id} className="p-4 rounded-xl border hover:bg-muted/50 transition-colors bg-card">
                                <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                                    <Link
                                        href={`/teacher/classes/${classId}/exams/${exam.id}`}
                                        className="flex-1 flex items-start gap-4 group"
                                    >
