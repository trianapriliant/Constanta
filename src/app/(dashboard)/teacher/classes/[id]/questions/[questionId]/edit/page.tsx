...
export default function EditQuestionPage() {
    ...
    useEffect(() => {
        async function fetchQuestion() {
            ...
            setPromptMd(question.prompt_md)
            setExplanationMd(question.explanation_md || '')
            setTags(question.tags || [])
            setCorrectAnswer(question.correct_answer_json)

            if (Array.isArray(question.options_json)) {
                setOptions(question.options_json.map((o: any) => ({
                    id: o.id || uuidv4(),
                    text_md: o.text_md
                })))
            }
        ...
        fetchQuestion()
    }, [classId, questionId, router, form])
